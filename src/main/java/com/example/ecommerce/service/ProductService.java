...
public interface ProductService {
    ...
    ProductDto createProduct(CreateProductDto createProductDto, MultipartFile file);

    PageableDto<ProductDto> searchProducts(String keyword, Category category, Size productSize,
